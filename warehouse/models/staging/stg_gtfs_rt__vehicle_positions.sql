...
unpack_json AS (
    SELECT
        ...
        CAST(JSON_VALUE(record, '$.entity.vehicle.position.latitude') AS NUMERIC) AS latitude,
        CAST(JSON_VALUE(record, '$.entity.vehicle.position.longitude') AS NUMERIC) AS longitude,
